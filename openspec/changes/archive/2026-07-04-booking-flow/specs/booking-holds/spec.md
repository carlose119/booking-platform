...
The system SHALL convert an active hold to a booking when the guest confirms. The booking MUST be created with status=pending and payment_status=unpaid.
